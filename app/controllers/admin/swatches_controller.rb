class Admin::SwatchesController < ApplicationController
  ...
  def update
    ...
    respond_to do |format|
      if @swatch.update(swatch_params)
        format.html { redirect_to [:admin, @swatch], notice: "Swatch was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to admin_swatches_path, notice: "Swatch was successfully destroyed.", status: :see_other }
